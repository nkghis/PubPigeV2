...
@section('title', 'Gestion des marques | Création')
@section('css')
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Nouvelle marque') }}</h3>
                        </div>
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('marques.store') }}" autocomplete="off">
                        @csrf

                        {{--<h6 class="heading-small text-muted mb-4">{{ __('Informations de l\'utilisateur') }}</h6>--}}
                        <div class="pl-lg-4">
                            @include('marques.partials._form')
