            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h3 class="modal-title">
                            <button type="button" class="btn btn-primary">
                                <strong>{{ str_plural('marques', $result->count()) }}</strong> <span class="badge badge-danger">{{ $result->count() }}</span>
                            </button>
                    ...
                    <div class="col-md-4 page-action text-right">
                        @can('add_marques')
                            <a href="{{ route('marques.create') }}" class="btn btn-primary btn-sm"> <i class="material-icons">open_in_new</i> <b>Nouveau</b></a>
                        @endcan
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm" id="data-table">
                        ...
                        <tr>
                            ...
                            <th>Client</th>
                            {{--<th>Date Création</th>--}}
                            @can('edit_marques', 'delete_marques')
                            ...
                            <tr>
                                ...
                                @can('edit_marques', 'delete_marques')
                                    <td class="text-center">
                                        @include('marques.shared._action', [
                                            'entity' => 'marques',
                                            'id' => $item->code
                                        ])
                                    </td>
