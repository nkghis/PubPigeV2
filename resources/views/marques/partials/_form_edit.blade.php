...
<div class="form-group row {{ $errors->has('marque-name') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="text" name="marque-name" id="input-name" class="form-control form-control-sm{{ $errors->has('marque-name') ? ' is-invalid' : '' }}" placeholder="{{ __('BMW') }}" value="{{ old('marque-name', $marques->libelle) }}"  autofocus>
