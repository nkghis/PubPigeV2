{{--for use change your "modelName" ain plural to "produits"--}}
            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h3 class="modal-title">
                            <button type="button" class="btn btn-primary">
                                <strong>{{ str_plural('Produits', $result->count()) }}</strong> <span class="badge badge-danger">{{ $result->count() }}</span>
                            </button>
                    ...
                    <div class="col-md-4 page-action text-right">
                        @can('add_produits')
                            <a href="{{ route('produits.create') }}" class="btn btn-primary btn-sm"> <i class="material-icons">open_in_new</i> <b>Nouveau</b></a>
                        @endcan
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                @can('edit_produits', 'delete_produits')
                                    <td class="text-center">
                                        @include('produits.shared._action', [
                                            'entity' => 'produits',
                                            'id' => $item->code
                                        ])
                                    </td>
