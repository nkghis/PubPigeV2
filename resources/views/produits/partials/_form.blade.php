...
<div class="form-group row {{ $errors->has('produit-name') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="text" name="produit-name" id="input-name" class="form-control form-control-sm{{ $errors->has('produit-name') ? ' is-invalid' : '' }}" placeholder="{{ __('X5') }}" value="{{ old('produit-name') }}"  autofocus>
