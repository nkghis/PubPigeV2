...
<div class="form-group row {{ $errors->has('campagne-name') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="text" name="campagne-name" id="input-campagne" class="form-control form-control-sm{{ $errors->has('campagne-name') ? ' is-invalid' : '' }}" placeholder="{{ __('Black Friday') }}" value="{{ old('campagne-name') }}"  autofocus>
...
<div class="form-group row {{ $errors->has('dp-campagne') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="date" name="dp-campagne" id="input-dp" class="form-control form-control-sm{{ $errors->has('dp-campagne') ? ' is-invalid' : '' }}" placeholder="{{ __('01/01/2000') }}" value="{{ old('dp-campagne') }}"  autofocus>
...
<div class="form-group row {{ $errors->has('fp-campagne') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="date" name="fp-campagne" id="input-fp" class="form-control form-control-sm{{ $errors->has('fp-campagne') ? ' is-invalid' : '' }}" placeholder="{{ __('01/12/2010') }}" value="{{ old('fp-campagne') }}"  autofocus>
...
<div class="form-group row {{ $errors->has('code-pays') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="text" name="code-pays" id="input-pays" class="form-control form-control-sm{{ $errors->has('code-pays') ? ' is-invalid' : '' }}" placeholder="{{ __('CIV') }}" value="{{ old('code-pays') }}"  autofocus>
...
<div class="form-group row {{ $errors->has('etat-campagne') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="number" min="1" name="etat-campagne" id="input-etat" class="form-control form-control-sm{{ $errors->has('etat-campagne') ? ' is-invalid' : '' }}" placeholder="{{ __('1') }}" value="{{ old('etat-campagne') }}"  autofocus>
...
<div class="form-group row {{ $errors->has('duree-campagne') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="number" min="1" name="duree-campagne" id="input-duree" class="form-control form-control-sm{{ $errors->has('duree-campagne') ? ' is-invalid' : '' }}" placeholder="{{ __('30') }}" value="{{ old('duree-campagne') }}"  autofocus>
        ...
        <select name="produit-name" id="input-produit" class="form-control form-control-sm{{ $errors->has('produit-name') ? ' is-invalid' : '' }}"  value="{{ old('produit-name') }}"  autofocus>
            @if($produits->count())
                ...
                @foreach ($produits as $produit)
                    <option value="{{$produit->code}}" >{{$produit->libelle}}</option>
                @endforeach
            @endif
        </select>
