            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h3 class="modal-title">
                            <button type="button" class="btn btn-primary">
                                <strong>{{ str_plural('Communes', $result->count()) }}</strong> <span class="badge badge-danger">{{ $result->count() }}</span>
                            </button>
                    ...
                    <div class="col-md-4 page-action text-right">
                        @can('add_communes')
                            <a href="{{ route('coms.create') }}" class="btn btn-primary btn-sm"> <i class="material-icons">open_in_new</i> <b>Nouveau</b></a>
                        @endcan
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm" id="data-table">
                        ...
                        <tr>
                            ...
                            <th>zoom</th>
                            <th>Date Création</th>
                            @can('edit_communes', 'delete_communes')
