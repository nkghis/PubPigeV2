...
<div class="form-group row {{ $errors->has('commune-id') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="number" min="1" name="commune-id" id="input-code" class="form-control form-control-sm{{ $errors->has('commune-id') ? ' is-invalid' : '' }}" placeholder="{{ __('1') }}" value="{{ old('commune-id') }}"  autofocus>
...
<div class="form-group row {{ $errors->has('commune-name') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="text"  name="commune-name" id="input-name" class="form-control form-control-sm{{ $errors->has('commune-name') ? ' is-invalid' : '' }}" placeholder="{{ __('KOUMASSI') }}" value="{{ old('commune-name') }}"  autofocus>
...
<div class="form-group row {{ $errors->has('commune-zoom') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="number" step="00.01" name="commune-zoom" id="input-zoom" class="form-control form-control-sm{{ $errors->has('commune-zoom') ? ' is-invalid' : '' }}" placeholder="{{ __('13.92') }}" value="{{ old('commune-zoom') }}"  autofocus>
