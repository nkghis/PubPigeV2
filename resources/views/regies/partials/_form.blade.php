...
<div class="form-group row {{ $errors->has('regie-name') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="text" name="regie-name" id="input-regie" class="form-control form-control-sm{{ $errors->has('regie-name') ? ' is-invalid' : '' }}" placeholder="{{ __('X5') }}" value="{{ old('regie-name') }}"  autofocus>
