...
@extends('layouts.app', ['title' => __('Gestion des models')])
@section('title', 'Gestion des models | Création')
@section('css')
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Nouveau models') }}</h3>
                        </div>
