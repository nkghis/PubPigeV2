...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Ceci est votre page de profil. Vous pouvez voir les progrès que vous avez réalisés dans votre travail et gérer vos projets ou tâches assignées'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            <a href="#" class="btn btn-sm btn-info mr-4">{{ __('Connexion') }}</a>
                    ...
                    <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    ...
                                    <div>
                                        ...
                                        <span class="description">{{ __('Commentaires') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Abidjan, Côte d\'ivoire') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Developpeur Solution - NDG') }}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ __('Universite Nandjui Abrogoua') }}
                            </div>
                            <hr class="my-4" />
                            <p>{{ __('Ghislain - Merci d\'utiliser notre application') }}</p>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4">{{ __('Enregister') }}</button>
                                </div>
                            </div>
                        </form>
                        <hr class="my-4" />
